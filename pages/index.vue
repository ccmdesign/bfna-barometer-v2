  ...
  <bar-section>
    <div class="switcher">
      ...
      <div class="section-panel">
        ...
        <ul>
          <li><a href="">Transatlantic Periscope</a></li>
          <li><a href="">Transatlantic Trends 2022</a></li>
          <li><a href="">RANGE - Transatlantic Forecasting Platform</a></li>
          <li><a href="">Sustainable Governance Indicators (SGI)</a></li>
          <li><a href="">Eupinions</a></li>
        </ul>
      </div>
    </div>
  </bar-section>
