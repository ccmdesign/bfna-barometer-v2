<template>
  <ccm-topbar class="topbar">
    <h1 unstyled><nuxt-link to="/" title="Transatlantic Barometer"><img src="/assets/barometer-logo.svg" alt="Transatlantic Barometer" loading="eager" /></nuxt-link></h1>
    <nav split-left>
    ...
    <h2 unstyled class="hide-on-mobile">
      <a href="https://www.bfna.org" target="_blank" title="Bertelsmann Foundation" class="topbar__logo">
        <img src="/assets/bfna-logo.svg" alt="Bertelsmann Foundation" loading="lazy" />
      </a>
    </h2>
  </ccm-topbar>
</template>
